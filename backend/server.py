...
def update_product(product_id):
    products = load_products()
    updated_product_data = request.json  # Assuming the request contains JSON data for the updated product
...
if __name__ == '__main__':
    print("here")
    app.run(debug=True)from flask import Flask , request , jsonify , send_from_directory
from flask_cors import CORS
import json
import os
